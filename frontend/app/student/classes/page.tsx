    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 relative z-10">
        <div className="space-y-2">
          ...
          <h1 className="text-4xl font-bold text-foreground dark:text-white tracking-tight">Classes Inscrites</h1>
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="relative flex-1">
          <Search className="absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-muted-foreground dark:text-gray-500" />
          <input
            type="text"
            placeholder="Rechercher une classe, une matière..."
            value={searchQuery}
            onChange={(e) => setSearchQuery(e.target.value)}
            className="w-full bg-[#111111] border border-[#222222] text-foreground dark:text-white rounded-xl pl-10 pr-4 py-3 focus:outline-none focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 transition-all placeholder:text-gray-600 shadow-sm"
          />
        </div>
        <Button variant="outline" className="h-[50px] bg-[#111111] border-[#222222] text-foreground dark:text-white hover:bg-[#1a1a1a] gap-2 rounded-xl">
          ...
          {loading ? (
            ...
            >
              <div className="w-16 h-16 bg-[#111111] rounded-full flex items-center justify-center mx-auto mb-4 border border-[#222222]">
                <BookOpen className="w-8 h-8 text-muted-foreground dark:text-gray-500" />
              </div>
              <h3 className="text-xl font-bold text-foreground dark:text-white mb-2">Aucune classe trouvée</h3>
              ...
              >
                ...
                <div className="h-16 bg-gradient-to-r from-indigo-600/20 to-purple-600/20 relative">
                  <div className="absolute -bottom-6 left-6 w-12 h-12 bg-[#111111] rounded-xl border border-[#222222] flex items-center justify-center p-2">
                    <div className="w-full h-full bg-gradient-to-br from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center text-foreground dark:text-white">
                ...
                <div className="p-6 pt-8 flex-1 flex flex-col">
                  <div className="flex justify-between items-start mb-2">
                    <h3 className="text-xl font-bold text-foreground dark:text-white group-hover:text-indigo-400 transition-colors line-clamp-1">
                      {cls.name}
                    </h3>
                    <span className="px-2.5 py-1 rounded-full text-[10px] font-bold tracking-wider uppercase bg-[#1a1a1a] border border-[#333333] text-muted-foreground dark:text-gray-400">
                      Nv. {cls.level}
                    </span>
                  </div>
                  
                  <p className="text-sm text-muted-foreground dark:text-gray-400 mb-6 flex items-center gap-2">
                  ...
                  <div className="mt-auto pt-4 border-t border-[#222222] flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-[#1a1a1a] border border-[#333333] flex items-center justify-center text-muted-foreground dark:text-gray-400 text-xs font-bold overflow-hidden relative">
                      ...
                      <div>
                        <p className="text-xs text-muted-foreground dark:text-gray-500">Professeur</p>
                  ...
                  <div className="absolute right-6 bottom-6 translate-x-4 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all z-20">
                    <div className="w-8 h-8 rounded-full bg-indigo-500 flex items-center justify-center text-foreground dark:text-white shadow-lg shadow-indigo-500/20">

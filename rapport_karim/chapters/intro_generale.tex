...
\begin{itemize}
    ...
    \item \textbf{Chapitre 3 : Réalisation du Sprint 1} -- détaille la conception technique, la modélisation de la base de données, la réalisation des interfaces et les tests liés à l'authentification et la gestion des utilisateurs.
\end{itemize}